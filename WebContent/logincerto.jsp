  ...
  <div class="section  blue-grey lighten-4">
    ...
    <div class="row">
      ...
      <div class="col s8 offset-s2 grey lighten-5 z-depth-1 " style="margin-top:-1%; padding-bottom:100%;" >
        <form class="col s12">
          ...
          <div class="row">
            ...
            <div class="input-field col s8 offset-s2">
              Username:<input placeholder="Username" id="username" type="text" class="validate" name='nome'>
        ...
        <div class="row">
          <div class="input-field col s8 offset-s2">
            Senha:<input placeholder="Username" id="password" type="password" class="validate" name='senha'>
