  ...
  <div class="section  blue-grey lighten-4">
    ...
    <div class="row">
      ...
      <div class="col s8 offset-s2 grey lighten-5 z-depth-1 hide-on-med-and-down" style="margin-top:-1%; padding-bottom:100%;" >
        <form class="col s12">
          ...
          <div class="row">
            ...
            <div class="input-field col s8 offset-s2">
             Username: <input placeholder="Username" id="username" type="text" class="validate" required="" aria-required="true" name='nome'>
        ...
        <div class="row">
          <div class="input-field col s8 offset-s2">
           Senha: <input placeholder="Username" id="password" type="password" class="validate" required="" aria-required="true"  name='senha'>
            <label for="first_name">Password</label>
          </div>
        </div>
        <div class="row">
            <div class="input-field col s8 offset-s2">
             Confirma: <input placeholder="Username" id="password" type="password" class="validate" required="" aria-required="true" name='confirm'>
